...
% figure(1)
% hold on;
% plot(0:k_max,fitting,'k',0:k01_max,fitting01,'r',0:k_max,P1,'ko',0:k01_max,P01,'ro' );
% box on;
...
% box on;
% axis([0 inf 0 inf]);
% imagesc(0:k_max,0:k01_max,Pjoint01);
...
save('F3.txt', 'F3','-ascii');
save('fit_F3.txt', 'fit_F','-ascii');
% save('k_max_0.txt', 'k_max','-ascii');
% save('k01_max.txt', 'k01_max','-ascii');
% save('fitting_0.txt', 'fitting','-ascii');
% save('fitting01.txt', 'fitting01','-ascii');
% save('P1_0.txt', 'P1','-ascii');
% save('P01.txt', 'P01','-ascii');
% save('Pjoint01.txt', 'Pjoint01','-ascii');