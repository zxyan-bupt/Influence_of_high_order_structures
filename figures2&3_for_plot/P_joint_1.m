...
cbar.Position=[0.88, 0.605, 0.0196, 0.342]; 
cbar.LineWidth=1;
text(45, 9.2, 'P(k,k_{\Delta})', 'HorizontalAlignment', 'center', 'FontName', 'Cambria Math', 'FontSize', 18);% 在 colorbar 上方手动添加注释
...
colorbar;
cbar=colorbar('eastoutside');  % 右侧外部
cbar.Position=[0.88, 0.102, 0.02, 0.34]; 
cbar.LineWidth=1;
text(51.3, 9.15, 'P(k,k_{\Delta})', 'HorizontalAlignment', 'center', 'FontName', 'Cambria Math', 'FontSize', 18);% 在 colorbar 上方手动添加注释

%调整子图位置
pos1 = ax1.Position; 
ax1.Position = [pos1(1)-0.01, pos1(2)+0.02, pos1(3), pos1(4)]; 
pos2 = ax2.Position; 
ax2.Position = [pos2(1)-0.02, pos2(2)+0.02, pos2(3), pos2(4)]; 
pos3 = ax3.Position; 
ax3.Position = [pos3(1)-0.03, pos3(2)+0.02, pos3(3), pos3(4)]; 
pos4 = ax4.Position; 
ax4.Position = [pos4(1)-0.04, pos4(2)+0.02, pos4(3), pos4(4)]; 
pos5 = ax5.Position; 
ax5.Position = [pos5(1)-0.01, pos5(2)-0.01, pos5(3), pos5(4)]; 
pos6 = ax6.Position; 
ax6.Position = [pos6(1)-0.02, pos6(2)-0.01, pos6(3), pos6(4)]; 
pos7 = ax7.Position; 
ax7.Position = [pos7(1)-0.03, pos7(2)-0.01, pos7(3), pos7(4)]; 
pos8 = ax8.Position; 
ax8.Position = [pos8(1)-0.04, pos8(2)-0.01, pos8(3), pos8(4)]; 
...
for i = 1:length(allAxes)
    axPos = get(allAxes(i), 'Position');
    set(allAxes(i), 'Position', [axPos(1), axPos(2), axPos(3)*0.95, axPos(4)]);
end